...
public class SegmentList {
    ...
    public SegmentList() {
        segmentInformation = new ArrayList<>();
    }
    ...
    public int hashCode() {
        int hash = 3;
        hash = 59 * hash + Objects.hashCode(this.segmentInformation);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SegmentList other = (SegmentList) obj;
        if (!Objects.equals(this.segmentInformation, other.segmentInformation)) {
            return false;
        }
        return true;
    }
