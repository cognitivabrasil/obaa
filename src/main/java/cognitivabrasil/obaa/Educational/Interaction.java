...
/**
 * <div class="en"> Specify the educational interaction proposed by this learning object
 *
 * Adapted from http://www.portalobaa.org </div>
 *
 * <div class="br"> Especifica a interação educacional proposta por este objeto de aprendizagem e seu(s) usuários.
 *
...
public class Interaction {
    ...
    public void setInteractionType(String interactionType) {
        this.interactionType = InteractionType.fromText(interactionType);
    }

    @Override
    public int hashCode() {
        int hash = 3;
        hash = 67 * hash + Objects.hashCode(this.interactionType);
        hash = 67 * hash + Objects.hashCode(this.perception);
        hash = 67 * hash + Objects.hashCode(this.synchronism);
        hash = 67 * hash + Objects.hashCode(this.coPresence);
        hash = 67 * hash + Objects.hashCode(this.reciprocity);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.perception, other.perception)) {
            return false;
        }
        if (!Objects.equals(this.synchronism, other.synchronism)) {
            return false;
        }
        if (!Objects.equals(this.coPresence, other.coPresence)) {
            return false;
        }
        return Objects.equals(this.reciprocity, other.reciprocity);
    }
